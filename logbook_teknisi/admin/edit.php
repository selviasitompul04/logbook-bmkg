...
{	
	...
	if(form.panci_status.value !="Perbaikan" && form.panci_file.value !=""){
				  ...
				  <div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ml-auto">
					  <li class="nav-item active">
						<a class="nav-link text-left" href="../index_admin.php">Home </a>
					  <li class="nav-item active">
				...
				<div class="row text-center">
					<div class="col-md-8 col-md-offset-2">
						...
						<div data-sr="enter left over 1s, wait 0.3s, move 24px" class="form-group col-md-12">
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="keternagan" class="form-control" name="pyranometer_keterangan" >
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="keterangan" class="form-control" name="pm25_keterangan" />
							</div>	
							</div>
							</td>
							</tr>
