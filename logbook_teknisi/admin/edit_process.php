...
require_once'../koneksi.php';
	...
	if(isset($_POST["input"])){
		...
		$nama_teknisi_status=$_POST["nama_teknisi_status"];
		...
		if($hvs_status !=""){
			...
			move_uploaded_file($hvs_name,$direct.$hvs);
			$query = mysqli_query($cons,"update report set hvs_status='',hvs_file='".$hvs."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 2 */
		if($baro_status !=""){
			...
			move_uploaded_file($baro_name,$direct.$baro);
			$query = mysqli_query($cons,"update report set baro_status='',baro_file='".$baro."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 3 */
		if($aws_status !=""){
			...
			move_uploaded_file($aws_name,$direct.$aws);
			$query = mysqli_query($cons,"update report set aws_status='',aws_file='".$aws."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 4 */
		if($radar_status !=""){
			...
			move_uploaded_file($radar_name,$direct.$radar);
			$query = mysqli_query($cons,"update report set radar_status='',radar_file='".$radar."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 5 */
		if($wrs_status !=""){
			...
			move_uploaded_file($wrs_name,$direct.$wrs);
			$query = mysqli_query($cons,"update report set wrs_status='',wrs_file='".$wrs."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 6 */
		if($campble_status!=""){
			...
			move_uploaded_file($campble_name,$direct.$campble);
			$query = mysqli_query($cons,"update report set campble_status='',campble_file='".$campble."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 7 */
		if($arws_status!=""){
			...
			move_uploaded_file($arws_name,$direct.$arws);
			$query = mysqli_query($cons,"update report set arws_status='',arws_file='".$arws."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 8 */
		if($pyranometer_status!=""){
			...
			move_uploaded_file($pyranometer_name,$direct.$pyranometer);
			$query = mysqli_query($cons,"update report set pyranometer_status='',pyranometer_file='".$pyranometer."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		...
		if($lightning_detec_status !=""){
			...
			move_uploaded_file($lightning_detec_name,$direct.$lightning_detec);
			$query = mysqli_query($cons,"update report set lightning_detec_status='',lightning_detec_file='".$lightning_detec."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 10 */
		if($awos_status !=""){
			...
			move_uploaded_file($awos_name,$direct.$awos);
			$query = mysqli_query($cons,"update report set awos_status='',awos_file='".$awos."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 11 */
		if($pm10_status !=""){
			...
			move_uploaded_file($pm10_name,$direct.$pm10);
			$query = mysqli_query($cons,"update report set pm10_status='',pm10_file='".$pm10."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 12 */
		if($pm25_status !=""){
			...
			move_uploaded_file($pm25_name,$direct.$pm25);
			$query = mysqli_query($cons,"update report set pm25_status='',pm25_file='".$pm25."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 13 */
		if($radios_status !=""){
			...
			move_uploaded_file($radios_name,$direct.$radios);
			$query = mysqli_query($cons,"update report set radios_status='',radios_file='".$radios."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 14 */
		if($d_bandara_status !=""){
			...
			move_uploaded_file($d_bandara_name,$direct.$d_bandara);
			$query = mysqli_query($cons,"update report set d_bandara_status='',d_bandara_file='".$d_bandara."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 15 */
		if($d_gubernur_status !=""){
			...
			move_uploaded_file($d_gubernur_name,$direct.$d_gubernur);
			$query = mysqli_query($cons,"update report set d_gubernur_status='',d_gubernur_file='".$d_gubernur."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 16 */
		if($d_bpbd_status!=""){
			...
			move_uploaded_file($d_bpbd_name,$direct.$d_bpbd);
			$query = mysqli_query($cons,"update report set d_bpbd_status='',d_bpbd_file='".$d_bpbd."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* ----------------------------------------------------------------------------------------------------------------------------------------------------------------- */
		/* 17 */
		...
		if($panci_status!=""){
			...
			move_uploaded_file($panci_name,$direct.$panci);
			$query = mysqli_query($cons,"update report set panci_status='',panci_file='".$panci."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 18 */
		if($sangkar_status!=""){
			...
			move_uploaded_file($sangkar_name,$direct.$sangkar);
			$query = mysqli_query($cons,"update report set sangkar_status='',sangkar_file='".$sangkar."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 19 */
		if($penakar_status!=""){
			...
			move_uploaded_file($penakar_name,$direct.$penakar);
			$query = mysqli_query($cons,"update report set penakar_status='',penakar_file='".$penakar."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 20 */
		if($synergie_status!=""){
			...
			move_uploaded_file($synergie_name,$direct.$synergie);
			$query = mysqli_query($cons,"update report set synergie_status='',synergie_file='".$synergie."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 21 */
		if($aerometweb_status!=""){
			...
			move_uploaded_file($aerometweb_name,$direct.$aerometweb);
			$query = mysqli_query($cons,"update report set aerometweb_status='',aerometweb_file='".$aerometweb."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 22 */
		if($internet_status!=""){
			...
			move_uploaded_file($internet_name,$direct.$internet);
			$query = mysqli_query($cons,"update report set internet_status='',internet_file='".$internet."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 23 */
		if($vpn_status!=""){
			...
			move_uploaded_file($vpn_name,$direct.$vpn);
			$query = mysqli_query($cons,"update report set vpn_status='',vpn_file='".$vpn."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 24 */
		if($soft_status!=""){
			...
			move_uploaded_file($soft_name,$direct.$soft);
			$query = mysqli_query($cons,"update report set soft_status='',soft_file='".$soft."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
		/* 25 */
		if($aftn_status!=""){
			...
			move_uploaded_file($aftn_name,$direct.$aftn);
			$query = mysqli_query($cons,"update report set aftn_status='',aftn_file='".$aftn."' where dates='".$date."'")or die(mysqli_connect_error() );
		} 
		/* 26 */
		if($debu_status!=""){
			...
			move_uploaded_file($debu_name,$direct.$debu);
			$query = mysqli_query($cons,"update report set debu_status='',debu_file='".$debu."' where dates='".$date."'")or die(mysqli_connect_error() );
		}
