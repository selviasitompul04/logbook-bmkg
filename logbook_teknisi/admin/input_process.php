...
require_once'../koneksi.php';
	...
	if(isset($_POST["input"])){
		...
		$dates = mysqli_real_escape_string($cons, $_POST['date']);
		...
		$query = mysqli_query($cons, "insert into report set dates='".$date."',hvs_status='".$hvs_status."',hvs_file='".$hvs."',baro_status='".$baro_status."',baro_file='".$baro."',aws_status='".$aws_status."',aws_file='".$aws."',radar_status='".$radar_status."',radar_file='".$radar."',wrs_status='".$wrs_status."',wrs_file='".$wrs."',campble_status='".$campble_status."',campble_file='".$campble."',arws_status='".$arws_status."',arws_file='".$arws."',pyranometer_status='".$pyranometer_status."',pyranometer_file='".$pyranometer."',awos_status='".$awos_status."',awos_file='".$awos."',lightning_detec_status='".$lightning_detec_status."',lightning_detec_file='".$lightning_detec."',pm10_status='".$pm10_status."',pm10_file='".$pm10."',pm25_status='".$pm25_status."',pm25_file='".$pm25."',radios_status='".$radios_status."',radios_file='".$radios."',d_bandara_status='".$d_bandara_status."',d_bandara_file='".$d_bandara."',d_gubernur_status='".$d_gubernur_status."',d_gubernur_file='".$d_gubernur."',d_bpbd_status='".$d_bpbd_status."',d_bpbd_file='".$d_bpbd."',panci_status='".$panci_status."',panci_file='".$panci."',sangkar_status='".$sangkar_status."',sangkar_file='".$sangkar."',penakar_status='".$penakar_status."',penakar_file='".$penakar."',synergie_status='".$synergie_status."',synergie_file='".$synergie."',aerometweb_status='".$aerometweb_status."',aerometweb_file='".$aerometweb."',internet_status='".$internet_status."',internet_file='".$internet."',vpn_status='".$vpn_status."',vpn_file='".$vpn."',soft_status='".$soft_status."',soft_file='".$soft."',aftn_status='".$aftn_status."',aftn_file='".$aftn."',debu_status='".$debu_status."',debu_file='".$debu."',coment='".$comment."'")or die (mysqli_error($cons));
