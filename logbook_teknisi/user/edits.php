...
{	
	...
	/* 1 */
	if(form.panci_status.value =="Perbaikan" && form.panci_file.value =="" || form.panci_status.value !="Perbaikan" && form.panci_file.value !=""){
		alert ("Harap hanya isi 'File' pada Panci Penguapan apabila status alat adalah 'Perbaikan/Perawatan'"); return false;	
	}
	
	/* 2 */
	if(form.sangkar_status.value =="Perbaikan" && form.sangkar_file.value =="" || form.sangkar_status.value !="Perbaikan" && form.sangkar_file.value !=""){
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<div data-sr="enter left over 1s, wait 0.3s, move 24px" class="form-group col-md-12">
							...
							<div data-sr="enter right over 1s, wait 0.3s, move 24px" class="form-group col-md-6">
								...
								<div class="form-group col-md-5 col-md-offset-4">
									<select name="panci_status">
										<option selected="selected" value="">Status Alat</option>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="panci_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="sangkar_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="arws_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="hvs_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="penakar_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="pyranometer_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="baro_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="awos_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="aws_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="lightning_detec_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="radar_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="pm10_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="pm25_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="synergie_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="aerometweb_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="wrs_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="radios_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="d_bandara_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="d_bpbd_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="d_gubernur_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="campble_file" value="" accept="application/pdf"/>
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="internet_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="vpn_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="soft_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="aftn_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter left over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-8 col-md-offset-4"> 
								<input type="file" class="form-control" name="debu_file" value="" accept="application/pdf" />
							</div>	
							</div>
							</td>
							</tr>
							...
							<div data-sr="enter bottom over 1s, wait 0.3s, move 24px, reset" class="form-group col-md-12">
								<br><textarea cols="60" rows="3" id="alamat" name="comment" class="form-control" placeholder="Catatan Teknisi"></textarea>
							</div>
							</td>
							</tr>
	...
	<div class="row">
        <div class="col-lg-12 text-center">
            <div class="footer-copy">
                © 2022 Logbook Teknisi by Stamet SSK II Pekanbaru. All Rights Reserved.
            </div>
        </div>
	</div>
